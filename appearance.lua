...
local function InitializeFontDropdown()
	...
	for i = 1, table.getn(FONT_CHOICES) do
		...
		-- Blizzard reuses DropDownList buttons. Set each visible button's
		-- FontString after it is populated so the name previews its own font.
...
local function BuildFontOption()
	...
	-- UIDropDownMenu text has 25px of internal left padding. 219 + 25 = 244,
	-- matching the control column used by the Appearance sliders above.
